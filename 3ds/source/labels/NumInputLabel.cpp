...
template <typename T>
NumInputLabel<T>::NumInputLabel(const int LabelX, const int LabelY, const T CurrentVal, const T MinVal, const T MaxVal, const std::string &InputText) : X(LabelX), Y(LabelY), CurrentVal(CurrentVal), MinVal(MinVal), MaxVal(MaxVal), InputText(InputText) {
