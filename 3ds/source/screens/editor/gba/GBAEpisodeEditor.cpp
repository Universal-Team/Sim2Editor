...
void GBAEpisodeEditor::ToggleEpisode() { this->ActiveEpisode->State(!this->ActiveEpisode->State()); };
...
void GBAEpisodeEditor::Draw(void) const {
	...
	switch(this->Tab) {
		case Tabs::Main:
			...
			GFX::DrawCheckbox(this->MainPositions[2].X, this->MainPositions[2].Y, this->ActiveEpisode->State());
			this->DrawStripes();
			break;
