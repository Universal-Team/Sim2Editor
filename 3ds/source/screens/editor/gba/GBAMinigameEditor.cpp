...
void GBAMinigameEditor::SelectMinigame() {
	std::unique_ptr<ListSelection> Ovl = std::make_unique<ListSelection>(S2Editor::Strings::GBAMinigameNames_EN, "Select a minigame you like to edit.", this->ActiveMinigame->Index());
...
void GBAMinigameEditor::Draw(void) const {
	...
	Gui::DrawStringCentered(0, 202, 0.5f, TEXT_COLOR, S2Editor::Strings::GBAMinigameNames_EN[this->ActiveMinigame->Index()]);
