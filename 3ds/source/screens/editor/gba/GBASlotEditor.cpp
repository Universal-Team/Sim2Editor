...
void GBASlotEditor::Draw(void) const {
	...
	Gui::DrawStringCentered(0, 110, 0.5f, TEXT_COLOR, "Ratings: " + SimUtils::RatingString(this->Slot->Ratings()));
	Gui::DrawStringCentered(0, 140, 0.5f, TEXT_COLOR, "Time: " + SimUtils::TimeString(this->Slot->Time(), false));
	GFX::DrawBottom();
